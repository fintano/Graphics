...
//Z축 라인,Object의 함수,변수를 이용하므로 상속받는다.
public class AxisZ extends Object {

	// Y축 초기화
	public void initShapes() {
		// (0,0,0)에서 (0,0,10)까지 뻗어나가는 선을 그릴려고 한다.
	...
	public void draw(Userdata data) {
		...
		GLES20.glVertexAttribPointer(data.VertexLoc, 3, GLES20.GL_FLOAT, false, 12, mVerticesBuffer);
